...
public class PrepareDiskInfoGUI {
	private static final Font textFont = new Font(Font.SERIF, Font.BOLD, 14);
    ...
    public static void createGUI() {
        ...
        whatIsTempButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
		        JOptionPane.showMessageDialog(null, StaticQuestionnaire.Dispatch(textFont,StaticQuestionnaire.getTempFilesExplanation()),
