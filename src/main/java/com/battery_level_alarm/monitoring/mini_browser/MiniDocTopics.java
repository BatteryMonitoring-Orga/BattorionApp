...
public class MiniDocTopics {
	...
	public static final String ENABLE_COMPUTER_NOTIFICATIONS = "Enable Your Computer Notifications";
	public static final String OUTPUT_AUDIO_DEVICE = "How do I select the audio output?";
	public static final String SYSTEM_TRAY_NOTIFICATION = "System Tray Notification";
	public static final String NOTIFICATION_SOUND = "Notification Sound";
	
	public static final String EXTERNAL_DOCS_HEADER = "─ External Documents ─";
	public static final String COMPREHENSIVE_BATTERY_GUIDE_AR = "Comprehensive Battery Guide (AR)";
