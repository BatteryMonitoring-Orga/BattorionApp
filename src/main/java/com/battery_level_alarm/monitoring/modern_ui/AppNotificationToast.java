package com.battery_level_alarm.monitoring.modern_ui;
...
public class AppNotificationToast {
	...
	public static void showNotification(String message, int batteryLevel, boolean isWelcomeMSG) {
		...
		Image icon = new Image(Objects.requireNonNull(
				AppNotificationToast.class.getResource("/com/battery_level_alarm/monitoring/tray-res/icons/hint.png")
		).toExternalForm());
	...
	public static Popup createSoundPopup(int soundLevel) {
		...
		soundSlider.getStylesheets().add(Objects.requireNonNull(AppNotificationToast.class.getResource(CSS_FOLDER_PATH + "slider.css")).toExternalForm());
